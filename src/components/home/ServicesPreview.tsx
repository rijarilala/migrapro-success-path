  ...
  return <section className="py-16 md:py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => <Card key={service.title} className={`hover-scale animate-fade-in border ${service.color}`} style={{
          animationDelay: `${(index + 1) * 100}ms`
              ...
              <CardContent>
                <Button variant="outline" className="w-full border-gray-300 hover:border-migrapro-terre-cuite hover:text-migrapro-terre-cuite" asChild>
